...
TOUTES LES API ONT ÉCHOUÉ - Voir logs pour détails`);
        ...
        async function analyzeWithGemini(subtitles, apiKey, videoUrl) {
            ...
            const prompt = `Tu es un expert analyste de contenu vidéo. Analyse ces sous-titres et crée un résumé détaillé en français avec une attention particulière aux RÉFÉRENCES PRÉCISES.

**VIDÉO:** ${videoId || 'Analyse manuelle'}
**INSTRUCTION SPÉCIALE:** Identifie et liste TOUTES les références mentionnées avec leurs détails exacts.
...
**3. RÉFÉRENCES CITÉES** ⭐ (TRÈS IMPORTANT)
Identifie et liste EXHAUSTIVEMENT toutes les références mentionnées:

📚 **LIVRES/AUTEURS:**
• [Titre exact] - [Auteur] ([Année si mentionnée])

🎬 **FILMS/SÉRIES:**
• [Titre exact] ([Année de sortie si mentionnée]) - [Réalisateur si mentionné]

🎨 **ŒUVRES D'ART/ARTISTES:**
• [Titre de l'œuvre] - [Artiste/Peintre] ([Époque/Année si mentionnée])

👤 **PERSONNAGES HISTORIQUES/CÉLÉBRITÉS:**
• [Nom complet] - [Contexte/Époque/Profession]

🏛️ **LIEUX/MONUMENTS:**
• [Nom exact] - [Localisation] ([Époque si mentionnée])

🔬 **CONCEPTS/THÉORIES SCIENTIFIQUES:**
• [Nom de la théorie/concept] - [Scientifique/Inventeur] ([Date si mentionnée])

🎵 **MUSIQUE/COMPOSITEURS:**
• [Titre] - [Compositeur/Artiste] ([Année si mentionnée])

📰 **ÉVÉNEMENTS HISTORIQUES:**
• [Événement] - [Date précise] - [Contexte]

🏢 **ENTREPRISES/MARQUES:**
• [Nom] - [Secteur] - [Période mentionnée]

**4. DÉTAILS TECHNIQUES**
[Concepts techniques expliqués dans la vidéo]

**5. ANECDOTES ET EXEMPLES**
[Histoires, exemples concrets mentionnés]

**6. CONCLUSION ET TAKEAWAYS**
[Apprentissages principaux et recommandations]

**SOUS-TITRES À ANALYSER:**
${subtitles}

**IMPORTANT:** 
- Sois EXHAUSTIF sur les références - ne manque aucune mention
- Donne les années/dates EXACTES quand mentionnées
- Distingue les références directes des allusions
- Si pas de références dans une catégorie, écris "Aucune référence trouvée"`;
        ...
        async function processVideo() {
            ...
            if (!manualSubtitles && !videoUrl) {
                showStatus('❌ URL YouTube OU sous-titres requis', 'error');
                return;
            }
            ...
            try {
                ...
                if (manualSubtitles && manualSubtitles.length > 50) {
                    ...
                    log(`Longueur: ${manualSubtitles.length} caractères`);
